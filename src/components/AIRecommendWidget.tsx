        ...
        "ai-recommend",
        {
          body: {
            ...
            messages: [
              {
                role: "user",
                content: `Suggest Indian travel destinations for someone interested in: ${
                  interests.join(", ") || "diverse experiences"
                }. Travel style: ${
                  travelStyles.join(", ") || "open to anything"
                }.`,
              },
            ],
          },
      ...
      <AnimatePresence mode="wait">
        ...
        {!loading && recommendations.length === 0 && !error && (
          <div className="text-center py-6">
            ...
            <p className="text-sm text-muted-foreground">
              Click "Get Suggestions" for AI-powered destination ideas
            </p>
          </div>
        )}
      </AnimatePresence>
