      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="pt-24 pb-16 px-4 sm:px-6 lg:px-8 mx-auto max-w-2xl text-center">
          <motion.div
            ...
            className="bg-card rounded-lg p-10 shadow-card"
          >
            ...
            <p className="mt-3 text-muted-foreground">
              Thank you, {form.name}! We'll review your application and get back
              to you within 48 hours.
            </p>
            <p className="mt-2 text-sm text-muted-foreground">
              Next steps: KYC verification → Profile review → Go live!
            </p>
          </motion.div>
        </div>
        <Footer />
      ...
      <div className="pt-24 pb-16 px-4 sm:px-6 lg:px-8 mx-auto max-w-3xl">
        ...
        >
          ...
          <p className="mt-2 text-muted-foreground">
            Share your India with the world. Monetize your knowledge,
        ...
        <motion.div
          ...
          className="mt-8 bg-card rounded-lg p-6 shadow-card"
        >
          {step === 0 && (
                ...
                {[
                  {
                    ...
                    icon: "🧭",
                    title: "Local Guide",
                    desc: "Lead personalized tours, show hidden spots, share local culture",
                  },
                  {
                    key: "Stay",
                    icon: "🏡",
                    title: "Homestay",
                    desc: "Host travelers in your home with authentic local experience",
                  },
                  {
                    key: "Transport",
                    icon: "🚗",
                    title: "Transportation",
                    desc: "Provide vehicle and driving services for travel within your region",
                  },
                ].map((s) => (
                  <button
                    key={s.key}
                    onClick={() => toggleArray("services", s.key)}
              ...
              {form.services.includes("Stay") && (
                <div className="p-4 rounded-lg bg-secondary">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <Input
                      value={form.homestayRooms}
                      onChange={(e) => update("homestayRooms", e.target.value)}
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Input
                  ...
                  placeholder="e.g. Your gateway to the Pink City's hidden gems"
                  maxLength={80}
                />
              ...
              <div>
                ...
                <Textarea
                  ...
                  placeholder="Share your story — what makes your region special, your background, and why you love hosting..."
                  rows={5}
                  maxLength={500}
                />
                <p className="text-xs text-muted-foreground mt-1">
              ...
              <div className="p-4 rounded-lg border border-dashed border-border bg-secondary/50 text-center">
                ...
                <p className="text-xs text-muted-foreground">
                  Add up to 5 photos that showcase you and your experiences
                </p>
                <Button
                  variant="outline"
                  size="sm"
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 rounded-lg bg-secondary">
                ...
                <ul className="text-sm text-muted-foreground space-y-1">
                  ...
                  <li>
                    ✓ Cancel or modify bookings anytime before confirmation
                  </li>
                </ul>
              </div>
