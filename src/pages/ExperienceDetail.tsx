...
const bikeExperiences = [
  {
    ...
    description:
      "Ride through the world's highest motorable passes on a Royal Enfield. Cross Khardung La (18,380 ft) and experience breathtaking Himalayan landscapes.",
    image:
    ...
    schedule: [
      {
        ...
        desc: "Acclimatization day. Explore Leh Market & Shanti Stupa.",
      },
      {
        day: "Day 2",
        title: "Leh to Khardung La",
        desc: "Ride to world's highest motorable pass at 18,380 ft.",
      },
      {
        day: "Day 3",
        title: "Nubra Valley",
        desc: "Ride through Nubra Valley, visit Diskit Monastery & sand dunes.",
      },
      {
        day: "Day 4",
        title: "Nubra to Pangong",
        desc: "Scenic ride to Pangong Lake via Shyok River route.",
      },
      {
        day: "Day 5",
        title: "Pangong Lake",
        desc: "Sunrise at Pangong, explore the lake's changing colors.",
      },
      {
        day: "Day 6",
        title: "Return to Leh",
        desc: "Ride back via Chang La pass. Evening free.",
      },
      {
        day: "Day 7",
        title: "Departure",
        desc: "Morning market visit, farewell breakfast, departure.",
      },
    ],
  },
  {
    id: "exp-bike-mahabaleshwar",
    title: "Mahabaleshwar Scooty Tour",
    description:
      "Explore the lush Western Ghats on a scooty — visit strawberry farms, ancient temples, and stunning viewpoints.",
    image:
    ...
    vehicleType: "Scooter",
    vehicleDetails: { model: "Honda Activa 6G", capacity: 2, type: "Scooter" },
    isYearRound: true,
    schedule: [
      {
        day: "8:00 AM",
        title: "Meet at base",
        desc: "Pick up your scooty and safety briefing.",
      },
      {
        day: "9:00 AM",
        title: "Strawberry Farms",
        desc: "Visit organic strawberry farms and taste fresh produce.",
      },
      {
        day: "11:00 AM",
        title: "Viewpoints",
        desc: "Arthur's Seat and Elephant's Head Point panoramic views.",
      },
      {
        day: "1:00 PM",
        title: "Lunch",
        desc: "Local Maharashtrian thali at a hilltop restaurant.",
      },
      {
        day: "3:00 PM",
        title: "Mapro Garden & Temples",
        desc: "Explore Mapro Garden and ancient temples.",
      },
      {
        day: "5:00 PM",
        title: "Return",
        desc: "Scenic ride back and drop off.",
      },
    ],
  },
  {
    id: "exp-bike-goa-cruise",
    title: "Goa Coastal Bike Cruise",
    description:
      "Cruise along Goa's scenic coastal roads on a Royal Enfield, stopping at hidden beaches, Portuguese forts, and local tavernas.",
    image:
    ...
    schedule: [
      {
        day: "7:30 AM",
        title: "Meet at Panjim",
        desc: "Bike allocation and coastal route briefing.",
      },
      {
        day: "9:00 AM",
        title: "Fort Aguada",
        desc: "Explore the iconic Portuguese fort and lighthouse.",
      },
      {
        day: "11:00 AM",
        title: "Beach Hopping",
        desc: "Vagator, Anjuna and hidden coves along the coast.",
      },
      {
        day: "1:00 PM",
        title: "Beach Shack Lunch",
        desc: "Fresh seafood lunch at a beachside shack.",
      },
      {
        day: "3:00 PM",
        title: "Chapora & Spice Farm",
        desc: "Chapora Fort views and spice plantation visit.",
      },
      {
        day: "5:30 PM",
        title: "Sunset Ride",
        desc: "Ride along the coast for sunset. GoPro highlights shared.",
      },
    ],
  },
  {
    id: "exp-bike-rajasthan",
    title: "Royal Rajasthan Bike Safari",
    description:
      "Ride through desert landscapes, visit ancient forts, and camp under the stars in the Thar Desert.",
    image:
    ...
    schedule: [
      {
        ...
        desc: "Ride through Aravalli hills, visit Pushkar Lake & Brahma Temple.",
      },
      {
        day: "Day 2",
        title: "Pushkar to Jodhpur",
        desc: "Desert highway ride. Evening Mehrangarh Fort visit.",
      },
      {
        day: "Day 3",
        title: "Jodhpur to Jaisalmer",
        desc: "Golden city arrival, explore havelis and fort.",
      },
      {
        day: "Day 4",
        title: "Sam Sand Dunes",
        desc: "Desert ride, camel safari, and camping under stars.",
      },
      {
        day: "Day 5",
        title: "Return via Village",
        desc: "Rural Rajasthan villages, farewell dinner in Jodhpur.",
      },
    ],
  },
];
...
const ExperienceDetail = () => {
  ...
  const hostReviews = reviews
    .filter((r) => r.hostId === exp.hostId)
    .slice(0, 3);
  ...
  const lastBookingDate =
    "lastBookingDate" in exp ? (exp as any).lastBookingDate : null;
  ...
  const vehicleDetails =
    "vehicleDetails" in exp ? (exp as any).vehicleDetails : null;

  const fallbackTimeline = [
    {
      day: "Start",
      title: "Meet your host",
      desc: `${exp.hostName} picks you up or meets you at the starting point`,
    },
    {
      day: "Morning",
    ...
    {
      day: "Midday",
      title: "Local meal included",
      desc: "Enjoy authentic local cuisine prepared by or recommended by your host",
    },
    {
      day: "Afternoon",
      title: "Deeper exploration",
      desc: "Visit hidden gems and interact with locals for a truly authentic experience",
    },
    {
      day: "End",
      title: "Farewell & memories",
      desc: "Exchange contacts, get local tips, and take home unforgettable memories",
    },
  ];
        ...
        <div className="relative h-[50vh] min-h-[350px] overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-10 mx-auto max-w-5xl">
            ...
            <div className="flex flex-wrap gap-2 mb-2">
              ...
              {exp.difficulty && (
                <span
                  className={`inline-block text-xs uppercase tracking-wider font-bold px-2 py-0.5 rounded-sm ${
                    exp.difficulty === "Hard" || exp.difficulty === "Extreme"
            ...
            <div className="flex items-center gap-4 mt-3 text-sm text-primary-foreground/90 flex-wrap">
              <span className="flex items-center gap-1">
                <MapPin className="w-4 h-4" /> {exp.hostCity}
              </span>
              <span className="flex items-center gap-1">
              ...
              {maxGuests && (
                <span className="flex items-center gap-1">
                  <Users className="w-4 h-4" /> Max {maxGuests} guests
                </span>
              )}
            </div>
          </div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                  <div className="rounded-xl bg-secondary p-3 text-center">
                    ...
                    <p className="font-bold text-foreground text-sm mt-1">
                      {isYearRound ? "Year-Round" : "Seasonal"}
                    </p>
                  </div>
                  {validFrom && (
                    <div className="rounded-xl bg-secondary p-3 text-center">
                      ...
                      <p className="font-bold text-foreground text-sm mt-1">
                        {new Date(validFrom).toLocaleDateString("en-US", {
                          month: "short",
                          day: "numeric",
                        })}
                      </p>
                  ...
                  {validTo && (
                    <div className="rounded-xl bg-secondary p-3 text-center">
                      ...
                      <p className="font-bold text-foreground text-sm mt-1">
                        {new Date(validTo).toLocaleDateString("en-US", {
                          month: "short",
                          day: "numeric",
                        })}
                      </p>
                  ...
                  {lastBookingDate && (
                    <div className="rounded-xl bg-destructive/5 border border-destructive/20 p-3 text-center">
                      ...
                      <p className="font-bold text-destructive text-sm mt-1">
                        {new Date(lastBookingDate).toLocaleDateString("en-US", {
                          month: "short",
                          day: "numeric",
                        })}
                      </p>
                ...
                <div className="rounded-2xl bg-card shadow-card p-5">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    ...
                    <div className="rounded-xl bg-secondary p-3 text-center">
                      ...
                      <p className="font-bold text-foreground text-sm mt-1">
                        {vehicleDetails.capacity} rider
                        {vehicleDetails.capacity > 1 ? "s" : ""}
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-24 space-y-4">
                <div className="rounded-2xl bg-card p-5 shadow-card">
                  ...
                  {exp.groupSize && (
                    <p className="text-xs text-muted-foreground mt-1 flex items-center gap-1">
                      <Users className="w-3 h-3" /> Group: {exp.groupSize}
                    </p>
                  )}
                ...
                {host && (
                  <Link
                    to={`/host/${host.id}`}
                    className="block rounded-2xl bg-card p-4 shadow-card hover:shadow-elevated transition-shadow"
                  >
