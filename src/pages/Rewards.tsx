...
const aiSuggestions = [
  {
    dest: "Udaipur",
    reason: "You love heritage walks — the City of Lakes awaits",
    match: 95,
    img: "🏰",
    month: "Jun",
  },
  {
    dest: "Spiti Valley",
    reason: "Based on your adventure preference",
    match: 91,
    img: "🏔️",
    month: "Jul",
  },
  {
    dest: "Hampi",
    reason: "History buff? Ancient ruins + bouldering!",
    match: 88,
    img: "🏛️",
    month: "Aug",
  },
  {
    dest: "Meghalaya",
    reason: "Monsoon magic — living root bridges",
    match: 85,
    img: "🌿",
    month: "Sep",
  },
  {
    dest: "Rann of Kutch",
    reason: "Unique landscapes for your feed",
    match: 82,
    img: "🌅",
    month: "Oct",
  },
  {
    dest: "Coorg",
    reason: "Coffee plantations & misty hills",
    match: 79,
    img: "☕",
    month: "Nov",
  },
  {
    dest: "Andaman",
    reason: "Beach finale for your epic year!",
    match: 96,
    img: "🏝️",
    month: "Dec",
  },
...
const badges = [
  ...
  { name: "Legend", icon: "👑", desc: "11-month streak", unlocked: false },
  {
    name: "Free Spirit",
    icon: "🦋",
    desc: "Claim your free trip",
    unlocked: false,
  },
];

const Rewards = () => {
  const [activeTab, setActiveTab] = useState<"streak" | "calendar" | "badges">(
    "streak"
  );
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <h1 className="text-3xl sm:text-4xl font-bold text-foreground mb-2">
              Trip Every Month.{" "}
              <span className="text-primary">12th is Free!</span>
            </h1>
            <p className="text-muted-foreground max-w-xl mx-auto">
              Travel 11 months in a row and earn your 12th trip completely free.
              Track your streak, unlock badges, and discover AI-curated
              destinations.
            </p>
          </motion.div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    {11 - currentStreak} more for your free trip!
                  </p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-6 sm:grid-cols-12 gap-2">
              {streakData.map((s, i) => (
                <div key={i} className="flex flex-col items-center gap-1">
                  ...
                  {s.dest && (
                    <span className="text-[8px] text-primary truncate w-12 text-center">
                      {s.dest}
                    </span>
                  )}
                </div>
            ...
            <div className="mt-4 p-3 rounded-xl bg-gradient-to-r from-primary/5 to-chart-3/5 border border-primary/10 flex items-center gap-3">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium">
                  12th Month ={" "}
                  <span className="text-primary font-bold">FREE Trip!</span>
                </p>
                <p className="text-xs text-muted-foreground">
                  Complete 11 monthly trips to unlock a complimentary experience
                  worth up to ₹25,000
                </p>
              </div>
          ...
          {activeTab === "streak" && (
            ...
            >
              ...
              <p className="text-sm text-muted-foreground mb-4">
                Based on your travel history, preferences, and seasonal trends —
                here's your perfect year plan.
              </p>
          ...
          {activeTab === "calendar" && (
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              <h3 className="font-semibold text-lg mb-4 flex items-center gap-2">
                <Calendar className="w-5 h-5 text-primary" /> Your 2026 Travel
                Calendar
              </h3>
                ...
                {streakData.map((s, i) => (
                  ...
                  >
                    ...
                    {s.dest ? (
                      ...
                      >
                        <ArrowRight className="w-3 h-3 mr-1" /> Find Your Next
                        Trip
                      </Button>
                    ) : (
                      <p className="text-xs text-muted-foreground">
              ...
              <div className="mt-8 bg-card rounded-xl border border-border p-6">
                ...
                <div className="space-y-3">
                  {[
                    {
                      streak: 3,
                      reward: "₹500 discount on next booking",
                      done: true,
                    },
                    {
                      streak: 5,
                      reward: "Free experience upgrade (worth ₹2,000)",
                      done: true,
                    },
                    {
                      streak: 7,
                      reward: "Priority booking + ₹3,000 credit",
                      done: false,
                    },
                    {
                      streak: 9,
                      reward: "VIP host access + ₹5,000 credit",
                      done: false,
                    },
                    {
                      streak: 11,
                      reward: "🎉 12th trip completely FREE (up to ₹25,000)",
                      done: false,
                    },
                  ].map((m, i) => (
                    <div
