        ...
        <div className="pt-24 pb-16 px-4 max-w-2xl mx-auto text-center">
          <div className="bg-card rounded-2xl p-10 shadow-card">
            ...
            <p className="mt-2 text-muted-foreground">
              Sign in to file or track grievances
            </p>
            <Link to="/signup">
              <Button className="mt-6 rounded-full px-8">Sign In</Button>
            </Link>
          </div>
        </div>
        <Footer />
      ...
      <div className="pt-24 pb-16 px-4 sm:px-6 lg:px-8 mx-auto max-w-4xl">
        ...
        >
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="mt-1 text-muted-foreground">
                File and track disputes for fair resolution
              </p>
            </div>
            <Button
            ...
            {[
              {
                icon: FileText,
                title: "1. File",
                desc: "Describe your issue with details",
              },
              {
                icon: MessageCircle,
                title: "2. Review",
                desc: "Admin investigates both parties",
              },
              {
                icon: CheckCircle,
                title: "3. Resolve",
                desc: "Fair resolution within 48-72 hours",
              },
            ].map((s) => (
              <div
                key={s.title}
          ...
          <h2 className="text-xl font-bold text-foreground mb-4">
            Your Grievances ({grievances.length})
          </h2>
          {loading ? (
            ...
            <div className="text-center py-12 bg-card rounded-2xl shadow-card">
              ...
              <p className="text-sm text-muted-foreground mt-1">
                That's great! No disputes to resolve.
              </p>
            </div>
          ) : (
                      ...
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        <span
                          className={`text-xs px-2 py-0.5 rounded-full font-medium ${
                            statusColors[g.status] || statusColors.open
                          }`}
                        >
                          {g.status}
                        </span>
