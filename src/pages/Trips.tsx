...
const natureColors: Record<string, string> = {
  ...
  spiritual: "bg-accent/10 text-accent",
  holy: "bg-accent/10 text-accent",
  cultural: "bg-secondary text-foreground",
};
      ...
      <div className="relative pt-20 pb-8 px-4 sm:px-6 lg:px-8 mx-auto max-w-7xl">
        ...
        >
          ...
          <p className="mt-3 text-lg text-muted-foreground">
            Join group trips hosted by fellow travelers
          </p>
        </motion.div>
        ...
        <div className="mt-6 flex flex-wrap gap-2 justify-center">
          {["adventure", "spiritual", "holy", "cultural"].map((n) => (
            <button
              key={n}
              onClick={() => setFilterNature(filterNature === n ? null : n)}
        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Be the first to{" "}
              <Link to="/host-trip" className="text-primary hover:underline">
                host a trip
              </Link>
              !
            </p>
                    ...
                    <div className="rounded-2xl bg-card shadow-card hover:shadow-elevated transition-all overflow-hidden group">
                      ...
                      <div className="p-4">
                        ...
                        <div className="flex items-center gap-3 mt-3 text-xs text-muted-foreground">
                          ...
                          {trip.start_date && (
                            <span className="flex items-center gap-1">
                              <Calendar className="w-3 h-3" /> {trip.start_date}
                            </span>
                          )}
                          <span className="flex items-center gap-1">
