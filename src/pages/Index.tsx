...
const howItWorks = [
  {
    ...
    icon: Search,
    title: "Discover",
    desc: "Browse verified hosts by city, vibe, or experience type.",
  },
  {
    step: "02",
    icon: MessageCircle,
    title: "Connect",
    desc: "Chat directly with your host. Ask questions, plan together.",
  },
  {
    step: "03",
    icon: CreditCard,
    title: "Book Securely",
    desc: "Pay with escrow protection. Multi-currency supported.",
  },
  {
    step: "04",
    icon: ThumbsUp,
    title: "Experience",
    desc: "Enjoy authentic local experiences. Share your story.",
  },
];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-[92vh] min-h-[650px] flex items-center overflow-hidden">
        ...
        <motion.div
          {...floatingAnimation}
          className="absolute top-[20%] right-[15%] hidden lg:block w-16 h-16 rounded-full bg-primary/20 backdrop-blur-sm"
        />
        <motion.div
          animate={{ y: [0, -15, 0] }}
          transition={{
          ...
          className="absolute top-[40%] right-[8%] hidden lg:block w-10 h-10 rounded-full bg-accent/20 backdrop-blur-sm"
        />
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 w-full">
          ...
          >
            ...
            >
              <Sparkles className="w-4 h-4 text-primary" /> Trusted by 25,000+
              travelers worldwide
            </motion.div>
            ...
            <p className="mt-4 text-lg text-primary-foreground/80 leading-relaxed max-w-md">
              Connect with verified local hosts for authentic Indian experiences
              — homestays, guided tours, and cultural immersion.
            </p>
            ...
            >
              ...
              <Link to={`/explore${searchQuery ? `?q=${searchQuery}` : ""}`}>
                <Button
                  size="lg"
                  className="rounded-xl bg-primary text-primary-foreground hover:bg-primary/90 px-6 w-full sm:w-auto gap-2"
                >
            ...
            >
              {["Jaipur", "Kerala", "Ladakh", "Varanasi", "Goa"].map((city) => (
                <Link
                  key={city}
                  to={`/destination/${city.toLowerCase()}`}
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 mx-auto max-w-7xl">
        ...
        >
          ...
          <p className="mt-2 text-muted-foreground max-w-lg mx-auto">
            From discovery to experience — we make it seamless
          </p>
        </motion.div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {howItWorks.map((item, i) => (
            ...
            >
              <span className="text-4xl font-black text-primary/10 absolute top-4 right-4">
                {item.step}
              </span>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 mx-auto max-w-7xl">
        <div className="flex items-end justify-between mb-8">
          <div>
            ...
            <p className="mt-2 text-muted-foreground">
              Verified locals ready to show you the real India
            </p>
          </div>
          <Link
            to="/explore"
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex items-end justify-between mb-8">
            <div>
              ...
              <p className="mt-2 text-muted-foreground">
                Group adventures curated by expert trip leaders
              </p>
            </div>
            <Link
              to="/trips"
                ...
                <Link to="/trips" className="block group">
                  <div className="rounded-2xl bg-card shadow-card hover:shadow-card-hover transition-all overflow-hidden">
                    <div className="h-48 overflow-hidden relative">
                      ...
                      />
                      <span className="absolute top-3 left-3 text-xs font-bold bg-card/90 backdrop-blur-sm px-3 py-1 rounded-full">
                        {trip.tag}
                      </span>
                      <span className="absolute top-3 right-3 text-xs font-medium bg-destructive/90 text-destructive-foreground px-3 py-1 rounded-full">
                        {trip.spots}
                      </span>
                    </div>
                    <div className="p-5">
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex items-end justify-between mb-8">
            <div>
              ...
              <p className="mt-2 text-muted-foreground">
                See what travelers are sharing right now
              </p>
            </div>
            <Link
              to="/community"
                  ...
                  <Link to="/community" className="block">
                    <div className="relative aspect-[9/16] rounded-2xl overflow-hidden group cursor-pointer shadow-card hover:shadow-elevated transition-all">
                      ...
                      <div className="absolute bottom-3 left-3 right-3">
                        ...
                        <p className="text-[10px] text-primary-foreground/80 line-clamp-1">
                          {reel.caption}
                        </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 mx-auto max-w-7xl">
        <div className="flex items-end justify-between mb-8">
          <div>
            ...
            <p className="mt-2 text-muted-foreground">
              Curated moments you can't find in guidebooks
            </p>
          </div>
          <Link
            to="/experiences"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {testimonials.map((t, i) => (
              ...
              >
                ...
                <span className="mt-3 inline-block text-[10px] bg-primary/10 text-primary px-2 py-0.5 rounded-full">
                  {t.trip}
                </span>
              </motion.div>
            ))}
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex items-end justify-between mb-8">
            <div>
              ...
              <p className="mt-2 text-muted-foreground">
                Explore India's most loved cities
              </p>
            </div>
            <Link
              to="/destinations"
              ...
              >
                ...
                >
                  <div className="rounded-2xl bg-card shadow-card hover:shadow-card-hover transition-all p-5 text-center group-hover:-translate-y-1">
                    <div className="w-12 h-12 rounded-full bg-primary/10 mx-auto mb-3 flex items-center justify-center text-xl">
                      📍
                    </div>
                    ...
                    {d.experienceTags && (
                      <div className="mt-2 flex flex-wrap justify-center gap-1">
                        {d.experienceTags.slice(0, 2).map((tag) => (
                          <span
                            key={tag}
                            className="text-[9px] bg-secondary text-muted-foreground px-1.5 py-0.5 rounded-full"
                          >
                            {tag}
                          </span>
                        ))}
        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex items-end justify-between mb-8">
            <div>
              ...
              <p className="mt-2 text-muted-foreground">
                Stories, guides, and insights from the Travelista community
              </p>
            </div>
            <Link
                ...
                <Link to={`/blog/${post.id}`} className="block group">
                  <div className="rounded-2xl bg-card shadow-card hover:shadow-card-hover transition-all overflow-hidden">
                    ...
                    <div className="p-5">
                      ...
                      <h3 className="font-bold text-foreground text-sm mt-2 line-clamp-2">
                        {post.title}
                      </h3>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          ...
          >
            ...
            <p className="mt-2 text-muted-foreground max-w-lg mx-auto">
              Every host is verified. Every payment is secured. Every journey is
              protected.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                desc: "KYC-verified identity, background checks, and video testimonials from past travelers.",
              },
              {
                icon: Users,
                title: "Real Connections",
                desc: "Chat with your host before booking. Know who you're traveling with — not just where.",
              },
              {
                icon: Sparkles,
                title: "Secure Payments",
                desc: "Escrow-based payments with multi-currency support. Pay only when you're satisfied.",
              },
            ].map((item, i) => (
              <motion.div
                key={item.title}
        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-foreground mt-4">
                Become a Beta Wanderer
              </h2>
              <p className="mt-3 text-muted-foreground leading-relaxed">
                Join our exclusive community of travel content creators. Explore
                new destinations, shoot reels, earn rewards, and help shape the
                future of travel.
              </p>
              <div className="mt-6 space-y-3">
                {[
                  {
                    icon: Zap,
                    text: "Earn points for every mission completed",
                  },
                  {
                    icon: Award,
                    text: "Unlock badges: Explorer → Trailblazer → Legend",
                  },
                  {
                    icon: Globe,
                    text: "Get assigned to trending destinations",
                  },
                  {
                    icon: CheckCircle,
                    text: "Free stays & exclusive host access",
                  },
                ].map((item) => (
            ...
            >
              <div className="bg-card rounded-2xl shadow-elevated p-8 text-center">
                ...
                <p className="text-sm text-muted-foreground mt-2">
                  Download the Travelista app for on-the-go bookings, live host
                  chat, and offline guides.
                </p>
                <div className="mt-6 flex justify-center gap-3">
                  <Button
                    variant="outline"
                    className="rounded-xl px-6 gap-2 text-sm"
                    disabled
                  >
                    App Store
                  </Button>
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          >
            ...
            <p className="mt-4 text-muted-foreground text-lg">
              Join thousands of travelers who chose connection over convenience.
            </p>
