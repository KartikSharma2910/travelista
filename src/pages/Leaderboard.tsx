...
const rewards = [
  ...
  },
  {
    tier: "Pioneer",
    minScore: 500,
    perks: ["₹2,000 travel credit", "Pioneer badge", "Early access to trips"],
    icon: Flame,
  ...
  },
  {
    tier: "Trailblazer",
    minScore: 250,
    perks: ["₹500 travel credit", "Trailblazer badge", "Community shoutout"],
    icon: TrendingUp,
    color: "text-accent",
  },
  {
    tier: "Explorer",
    minScore: 0,
    perks: ["Explorer badge", "Leaderboard visibility"],
    icon: Target,
    color: "text-primary",
  },
];
      ...
      .then(({ data }) => {
        if (data && data.length > 0) {
          const merged = [
            ...
            ...data.map((d) => ({
              ...d,
              weeklyScore: Math.floor((d.score || 0) * 0.2),
              monthlyScore: d.score || 0,
            })),
          ];
      ...
      <div className="pt-20 pb-16 px-4 sm:px-6 lg:px-8 mx-auto max-w-5xl">
        ...
        >
          ...
          <p className="text-muted-foreground mt-2">
            Recognizing our most active community explorers
          </p>
        </motion.div>
              ...
              {[1, 0, 2].map((idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      className={`${height} w-24 rounded-t-xl bg-gradient-to-b ${podiumColors[idx]} mt-2 flex items-start justify-center pt-3`}
                    >
