...
const Community = () => {
  ...
  const [activeTab, setActiveTab] = useState<Tab>(
    (searchParams.get("tab") as Tab) || "reels"
  );
      ...
      <div className="pt-24 pb-16 px-4 sm:px-6 lg:px-8 mx-auto max-w-7xl">
        ...
        >
          ...
          <p className="mt-3 text-lg text-muted-foreground max-w-2xl mx-auto">
            Stories, reels, and inspiration from the Travelista family
          </p>
        </motion.div>
                ...
                {communityReels
                  ...
                  .map((reel, i) => (
                    <motion.div
                      ...
                      onClick={() =>
                        setSelectedReel(
                          selectedReel === reel.id ? null : reel.id
                        )
                      }
                    ...
                    >
                      ...
                      <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                        <motion.div
                          ...
                          className="w-14 h-14 rounded-full bg-primary/90 backdrop-blur-sm flex items-center justify-center shadow-elevated"
                        >
                      ...
                      <div className="absolute bottom-0 left-0 right-0 p-3">
                        <p className="text-xs font-bold text-primary-foreground">
                          {reel.travelerName} · {reel.country}
                        </p>
                        <p className="text-[11px] text-primary-foreground/90 line-clamp-2 mt-0.5">
                          {reel.caption}
                        </p>
              ...
              {communityReels.map((reel, i) => (
                ...
                >
                  ...
                  <div
                    ...
                    onClick={() =>
                      setSelectedReel(selectedReel === reel.id ? null : reel.id)
                    }
                  >
                    <img
                      src={reel.thumbnail}
                ...
                <Link to={`/host/${h.id}`} className="block group">
                  <div className="rounded-2xl bg-card shadow-card hover:shadow-card-hover transition-all p-6 text-center">
                    <div className="relative w-20 h-20 mx-auto mb-4">
                      ...
                      />
                      {h.verified && (
                        <span className="absolute -bottom-1 -right-1 w-6 h-6 bg-accent text-accent-foreground rounded-full flex items-center justify-center text-xs">
                          ✓
                        </span>
                      )}
                    </div>
            ...
            {travelTips.map((tip, i) => (
              <motion.div
                ...
                className={`rounded-xl p-5 cursor-pointer transition-all ${
                  expandedTip === tip.id
                    ? "bg-card shadow-elevated ring-1 ring-primary/20"
                    ...
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span
                        className={`text-[10px] px-1.5 py-0.5 rounded-full uppercase tracking-wider ${
                          tipCategoryColors[tip.category] ||
