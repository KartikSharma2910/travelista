...
const Membership = () => {
  ...
  const handleSubscribe = async (
    tierId: "free" | "explorer" | "adventurer" | "nomad",
    price: number
  ) => {
    if (!user) {
      navigate("/signup");
      ...
      <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Choose a plan that fits your travel style. Unlock exclusive deals,
            priority access, and the Beta Wanderer program.
          </p>
        </div>
